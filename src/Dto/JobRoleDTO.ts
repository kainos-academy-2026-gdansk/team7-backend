...
export const updateJobRoleSchema = z
  .object({
    ...
    statusId: z.number().int("Status id must be an integer").positive("Status id is required"),
    ...
    sharepointUrl: z.url("Must be a valid URL").nullable(),
    numberOfOpenPositions: z.number().int().nonnegative().nullable(),
...
export const AddJobRoleRequestSchema = z
  .object({
    roleName: z
      .string()
    ...
    numberOfOpenPositions: z
      ...
      .optional()
      .nullable(),
    sharepointUrl: z.string().url("SharePoint link must be a valid URL").optional().nullable(),
    closingDate: z
      .string()
      .datetime()
      .optional()
